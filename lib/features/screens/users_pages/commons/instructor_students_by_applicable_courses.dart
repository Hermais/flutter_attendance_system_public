...
class InstructorCourses extends StatelessWidget {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return InfoCard(
            ...
            cardDescription: "Students of $routeName will be shown here.",
            cardTitle: "Student ${index + 1}",
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => returnStudentsAttendanceWeeks(
  ...
  Widget returnStudentsAttendanceWeeks({required String studentName, bool withScaffold = false}) {
    if(withScaffold){
      return ListView.builder(
            itemCount: 12,
            itemBuilder: (context, index) {
              return InfoCard(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => showStudentsAttendance(
  ...
  Widget showStudentsAttendance(
      {required String studentName, required String week}) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Attendance of $studentName'),
      ),
